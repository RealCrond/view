...
void C360SafeFrameWnd::Notify(TNotifyUI& msg)
	{
		if (msg.sType == _T("windowinit")) OnPrepare();
			...
			if (msg.pSender == m_pCloseBtn) {
				...
				::PostMessage(m_pSunDialog->GetHWND(), 65535, 0, 0);
			}
			...
			{
				m_pSunDialog = new CBaseWnd();
				if (m_pSunDialog == NULL) return;
				m_pSunDialog->Create(NULL, _T("360安全卫士"), WS_EX_TOOLWINDOW, 0L, 0, 0, 500, 372);
				m_pSunDialog->CenterWindow();
				::ShowWindow(*m_pSunDialog, SW_SHOW);
			}
		}
